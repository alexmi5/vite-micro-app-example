...
"./App":()=>{
      ...
      return __federation_import('/vite-micro-app-example/assets/__federation_expose_App-B9sCTIf7.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
      const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
        ...
        const base = '/vite-micro-app-example/';
        'assets';
